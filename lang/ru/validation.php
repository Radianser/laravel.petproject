...
return [
    ...
    */
    ...
    'password' => [
        ...
        // не переводится на другие языки, баг в этой версии ларавел
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'max' => [
                'string' => 'Имя не должно быть больше :max символов.',
            ],
        ],
        'email' => [
            'required' => 'Необходимо ввести адрес электронной почты.',
            'string' => 'Адрес электронной почты должен быть строкой.',
            'email' => 'Адрес должен быть электронной почтой.',
            'max' => [
                'string' => 'Адрес электронной почты не должен быть больше :max символов.',
            ],
        ...
        'password' => [
            ...
            'current_password' => 'Новый пароль не может быть равен текущему.',
            'min' => [
                'string' => 'Пароль должен содержать не менее :min символов.',
            ],

            // не изменяются, баг в этой версии ларавел
            // 'mixed' => 'Пароль должен содержать хотя бы одну прописную и одну строчную букву.',
            // 'uncompromized' => 'Данный пароль появился в результате утечки данных. Пожалуйста, выберите другой пароль.',
        ],
        'avatar' => [
            'required' => 'Необходимо выбрать фотографию.',
            'file' => 'Фотография должна быть файлом.',
            'max' => [
                'file' => 'Размер фотографии не должен превышать :max килобайт.',
            ],
        ],
        'cover' => [
            'required' => 'Необходимо выбрать обложку.',
            'file' => 'Обложка должна быть файлом.',
            'max' => [
                'file' => 'Размер обложки не должен превышать :max килобайт.',
            ],
        ],
        'message' => [
            'required' => 'Пост не может быть пустым.',
            'string' => 'Пост должен быть строкой.',
            'max' => [
                'string' => 'Длина поста не может превышать :max символов.',
            ],
        ],
        'add_files' => [
            'array' => "Элемент должен быть массивом.",
            'max' => [
                'array' => 'Количество единовременно загружаемых файлов не может быть более :max.',
            ],
        ],
        'add_links' => [
            'array' => "Элемент должен быть массивом.",
            'max' => [
                'array' => 'Количество единовременно прикрепляемых ссылок не может быть более :max.',
            ],
        ],
        'file*' => [
            'mimes' => 'Файл должен соответствовать одному из типов: :values.',
            'max' => [
                'file' => 'Размер файла не должен превышать 200 мегабайт.',
            ],
        ],
    ],
